...
<!--
    ...
    <li class="pure-menu-item"><a href="main.php?EX=git" class="pure-menu-link" style="display:block;">$this->git Git</a></li>
    ...
    <li class="pure-menu-item"><a href="mailto:jerome.villiseck@gmail.com" class="pure-menu-link">$this->phone Contact</a></li>
